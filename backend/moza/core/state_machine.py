...
_TRANSITIONS: dict[TaskStatus, set[TaskStatus]] = {
    ...
    TaskStatus.WAITING_APPROVAL: {TaskStatus.RUNNING, TaskStatus.EXECUTING, TaskStatus.CANCELLED},
    TaskStatus.WAITING_TOOL: {TaskStatus.RUNNING, TaskStatus.EXECUTING, TaskStatus.FAILED},
    TaskStatus.WAITING_USER: {TaskStatus.RUNNING, TaskStatus.EXECUTING, TaskStatus.CANCELLED},
    ...
    TaskStatus.RUNNING: {TaskStatus.WAITING_TOOL, TaskStatus.WAITING_USER, TaskStatus.RUNNING, TaskStatus.COMPLETED, TaskStatus.FAILED, TaskStatus.CANCELLED},
